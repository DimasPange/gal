              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di galeri website</h1>
                  </div>
                  <form method="post" action="proses-login.php"class="user">
                    ...
                    <div class="form-group">
                      <input name="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="MasukanPassword" required>
                    </div>
                   ...
                   <!-- <a href="index2.php" class="btn btn-success btn-user btn-block"> 
                      <i class="fa fa-laptop fa-fw"></i> login petugas / admin
                    </a>-->
