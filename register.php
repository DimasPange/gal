              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Registrasi Akun</h1><h2>galeri foto</h2>
                  </div>

                  <form class="user" method="post" action="proses-register.php" >
                    <div class="form-group">
                      <input type="text" name="id_user" class="form-control form-control-user" placeholder="Masukkan NISN" required>
                    </div>
                    <div class="form-group">
